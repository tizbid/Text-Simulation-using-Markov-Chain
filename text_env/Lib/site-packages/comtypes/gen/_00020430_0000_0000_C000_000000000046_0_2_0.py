...
__all__ = [ 'OLE_COLOR', 'OLE_XPOS_HIMETRIC', 'OLE_ENABLEDEFAULTBOOL',
           'FONTSIZE', 'IFont', 'Gray', 'Default', 'StdPicture',
           ...
           'OLE_HANDLE', 'FONTUNDERSCORE', 'Checked', 'Color',
           'IPicture', 'OLE_YPOS_PIXELS', 'Picture', 'IFontDisp',
           'StdFont', 'VgaColor', 'OLE_XSIZE_PIXELS', 'Monochrome',
           'OLE_YPOS_CONTAINER', 'IFontEventsDisp',
           'OLE_XPOS_CONTAINER', 'Unchecked', 'LoadPictureConstants',
           'Font', 'FONTNAME', 'OLE_YSIZE_HIMETRIC', 'IPictureDisp',
